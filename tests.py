...
class tests(TestCase):
    def __init(self):
        self.normal_type = Type(id=1, name="normal", generation=1, immunities=[], strengths=[], weaknesses=[])
        self.grass_type = Type(id=12, name="grass", generation=1, immunities=[], strengths=[], weaknesses=[])
        self.poison_type = Type(id=4, name="poison", generation=1, immunities=[], strengths=[], weaknesses=[])
        self.tackle_move = Move(id=33, name="tackle", accuracy=100, pp=35, priority=0, power=50,
                                damage_class="physical",
                                move_type=self.normal_type)
        self.pokemon = Pokemon(id=1, name="bulbasaur", hp=45, attack=49, defense=49, special_attack=65,
                               special_defense=65,
                               speed=45, average_stats=53, primary_type=self.grass_type,
                               secondary_type=self.poison_type,
                               moves=[self.tackle_move])
    ...
    def test_pokemon_deletable(self):
        ...
        db.session.delete(self.pokemon)
        db.session.commit()
    ...
    def test_type_writeable(self):
        ...
        db.session.add(self.grass_type)
        db.session.commit()
    ...
    def test_type_deletable(self):
        ...
        db.session.delete(self.grass_type)
        db.session.commit()
    ...
    def test_move_writable(self):
        ...
        db.session.add(self.tackle_move)
        db.session.commit()
    ...
    def test_move_deleteable(self):
        ...
        db.session.delete(self.tackle_move)
        db.session.commit()
